...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        Map<Month, Double> averageOccupancyByMonth = rows.stream()
                ...
                .collect(Collectors.groupingBy(row -> row.getExtractDate().getMonth(), Collectors.averagingDouble(Row::getOccupancyRate)));
        ...
        new ObjectMapper().writeValue(Files.newOutputStream(Paths.get("out.json")), stats);
    }
